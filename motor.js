...
function calculoMotor(tipoNomina="",fechaPrimeroEmpleo='19-06-2024', genero=""){
    var arrayR=array.find((element) => (element.tipoNomina=tipoNomina) && (element.fechaPrimeroEmpleo=fechaPrimeroEmpleo) && (element.genero=genero));
    console.log(arrayR)
    
    var montoMinimo=Math.min(arrayR.monto);
    var montoMaximo=Math.max(arrayR.monto);
...
console.log(calculoMotor("B",'19-09-2020',"f"));